...
class RoundHoleObject(MujocoXMLObject):
    """
    Square holer (used in SoftPegInHole)
    """
...
class SquareHoleObject(MujocoXMLObject):
    """
    Round hole (used in SoftPegInHole)
    """
...
class SquareHoleOldObject(MujocoXMLObject):
    """
    Round hole (used in SoftPegInHole)
    """
...
class TriangleHoleObject(MujocoXMLObject):
    """
    Triangle hole (used in SoftPegInHole)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/triangle_hole.xml"),
            name=name,
            joints=None,
            obj_type="all",
            duplicate_collision_geoms=True,
...
class PentagonHoleObject(MujocoXMLObject):
    """
    Pentagon hole (used in SoftPegInHole)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/pentagon_hole.xml"),
            name=name,
            joints=None,
            obj_type="all",
            duplicate_collision_geoms=True,
...
class HexagonHoleObject(MujocoXMLObject):
    """
    Hexagon hole (used in SoftPegInHole)
    """

    def __init__(self, name):
        super().__init__(
            xml_path_completion("objects/hexagon_hole.xml"),
            name=name,
            joints=None,
            obj_type="all",
            duplicate_collision_geoms=True,
