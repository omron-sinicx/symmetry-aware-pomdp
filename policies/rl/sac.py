...
class SAC(RLAlgorithmBase):
    ...
    def critic_loss(
        ...
        with torch.no_grad():
            ...
            if markov_actor:
                new_actions, new_log_probs, _, _ = self.forward_actor(
    ...
    def actor_loss(
        ...
        if markov_actor:
            new_actions, log_probs, mean, _ = self.forward_actor(actor, observs)
        else:
            new_actions, log_probs, mean, _ = actor(
        ...
        return policy_loss, log_probs, mean
