...
from policies.models.actor import DeterministicPolicy, EquiDeterministicPolicy
...
class TD3(RLAlgorithmBase):
    ...
    @staticmethod
    def build_equi_actor(input_size, action_dim, hidden_sizes,
                         group_helper, **kwargs):
        return EquiDeterministicPolicy(
            obs_dim=input_size,
            action_dim=action_dim,
            hidden_sizes=hidden_sizes,
    ...
    def actor_loss(
        ...
        return policy_loss, None, new_actions
